...
ACCESS_TOKEN = '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'
...
def get_latest_release_info(username, repository, access_token):
    """Get latest release info from private GitHub repository.
...
def show_update_details_dialog(
    ...
    """
    # Temporary disable update function, open url instead
