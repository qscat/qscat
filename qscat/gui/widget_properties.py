...
def set_shorelines_tab_widget_properties(self):
    ...
    self.dockwidget.qfcb_shorelines_date_field.setFilters(QgsFieldProxyModel.String)
...
def set_baseline_tab_widget_properties(self):
    ...
    self.dockwidget.qfcb_baseline_smoothing_field.setLayer(
        self.dockwidget.qmlcb_baseline_baseline_layer.currentLayer()
    )

    # Show only string fields for placement and orientation
    self.dockwidget.qfcb_baseline_placement_field.setFilters(QgsFieldProxyModel.String)
    ...
    self.dockwidget.qfcb_baseline_length_field.setFilters(QgsFieldProxyModel.Int)
    self.dockwidget.qfcb_baseline_smoothing_field.setFilters(QgsFieldProxyModel.Int)
...
def set_about_tab_widget_properties(self):
    ...
    if last_checked_datetime is None:
        self.dockwidget.lbl_about_latest_version.setText("Update not yet checked.")
    else:
